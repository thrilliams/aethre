...
(function (A, w) {
    ...
    c.event = {add:function (a, b, d, f) {
        ...
        return a.result
    }, props:"altKey attrChange attrName bubbles button cancelable charCode clientX clientY ctrlKey currentTarget data detail eventPhase fromElement handler keyCode layerX layerY metaKey newValue offsetX offsetY originalTarget pageX pageY prevValue relatedNode relatedTarget screenX screenY shiftKey srcElement target toElement viewport wheelDelta which".split(" "),
        fix:function (a) {
            if (a[G])return a;
            var b = a;
            a = c.Event(b);
